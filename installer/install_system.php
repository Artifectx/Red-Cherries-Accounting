...
if ($taskType == 'install') {
	...
	if (mysqli_query($mysqli, "SELECT * FROM `common_configurations`")) {
		$result = mysqli_fetch_array(mysqli_query($mysqli, "SELECT `config_filed_value` FROM `common_configurations` WHERE `config_filed_name` LIKE 'red_cherries_os_version_number'"));
