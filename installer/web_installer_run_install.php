...
<html lang="en">
	...
	<body>
		...
		<h4 class="form_title">Step 2 : <?php echo ucfirst($_GET['type']);  ?> System</h4>
		<form id="install_system_form" action="" method="post">
			...
			<fieldset class="account-action">
				<input class="btn" id="install_button" type="button" name="install_button" value="<?php echo ucfirst($_GET['type']);  ?>">
				<input class="btn" id="login_button" type="button" name="login_button" value="Next">
			</fieldset>
		</form>
