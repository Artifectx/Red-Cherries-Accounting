					...
					<div class='col-sm-12'>
						<div class='page-header'>
							<h1 class='pull-left'>
								...
								<span><?php echo $this->lang->line('Reports Help') ?></span>
							</h1>
					...
					<div class='col-sm-12'>
						<div class='box'>
							<div class='box-header <?php echo BOXHEADER; ?>-background'>
								<div class='title' <?php echo $menuFormatting; ?>><?php echo $this->lang->line('Reports Help') ?></div>
								<div class='actions'>
								...
								<div class='form-group'>
									<div class='col-sm-3 col-sm-offset-1'>
										<button class='btn btn-success' type='submit' id="download" name='download' value='download_user_guide' <?php echo $menuFormatting; ?>>
											<i class='icon-save'></i>
											<?php echo $this->lang->line('Download Reports Help User Guide') ?>
										</button>
									</div>
								</div>  
								<!--</form>-->
