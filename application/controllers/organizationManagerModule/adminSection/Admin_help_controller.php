...
class Admin_help_controller extends CI_Controller {
	...
	public function index() {
		...
		$this->load->view('web/organizationManagerModule/adminSection/help/index');
	...
	public function downloadAdminHelpUserGuide() {
		...
		$data = file_get_contents(base_url() . "userGuides/organizationManagerModule/adminSection/Organization_Manager_Admin_User_Guide.pdf"); // Read the file's contents
		$name = 'Organization_Manager_Admin_User_Guide.pdf';
