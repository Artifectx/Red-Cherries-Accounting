...
class Admin_help_controller extends CI_Controller {
	...
	public function index() {
		...
		$this->load->view('web/accountsManagerModule/adminSection/help/index');
	...
	public function downloadGeneralLedgerHelpUserGuide() {
		...
		$data = file_get_contents(base_url() . "userGuides/accountsManagerModule/adminSection/Accounts_Manager_Admin_User_Guide.pdf"); // Read the file's contents
		$name = 'Accounts_Manager_Admin_User_Guide.pdf';
