...
class Accounts_report_help_controller extends CI_Controller {
	...
	public function index() {
		...
		$data_cls['li_class_account_report_help'] = 'active';
		...
		$this->load->view('web/accountsManagerModule/reportsSection/help/index');
	...
	public function downloadReportsHelpUserGuide() {
		...
		$data = file_get_contents(base_url() . "userGuides/accountsManagerModule/reportsSection/Accounts_Manager_Reports_User_Guide.pdf"); // Read the file's contents
		$name = 'Accounts_Manager_Reports_User_Guide.pdf';
