...
class Admin_help_controller extends CI_Controller {
	...
	public function index() {
		...
		$data_cls['li_class_admin_help'] = 'active';
		...
		$this->load->view('web/serviceManagerModule/donationManagerModule/adminSection/help/index');
	...
	public function downloadAdminHelpUserGuide() {
		...
		$data = file_get_contents(base_url() . "userGuides/serviceManagerModule/donationManagerModule/adminSection/Donation_Manager_Admin_User_Guide.pdf"); // Read the file's contents
		$name = 'Donation_Manager_Admin_User_Guide.pdf';
